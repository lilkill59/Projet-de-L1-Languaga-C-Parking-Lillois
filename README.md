...
1. Clone ce dépôt sur ta machine locale et accède au dossier du projet :
   `git clone https://github.com/lilkill59/Projet-de-L1-Languaga-C-Parking-Lillois.git "projet parking" && cd "projet parking"`
...
1. **Lancer le programme** :
   - Compile le projet (voir section [Compilation](#compilation)).
...
Pour compiler le projet, place-toi dans le dossier racine du projet et exécute la commande suivante :
`mkdir -p build && gcc -o build/parking src/*.c -I include`
